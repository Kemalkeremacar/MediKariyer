...
export const hospitalApiRequest = {
  ...
  /**
   * Departman API çağrıları
   */
  
  /**
   * Tüm departmanları getirir
   * 
   * @returns {Promise} Departments array promise
   */
   ...
   * 
   * @param {Object} data - Departman verisi
   * @returns {Promise} Create response promise
   */
   ...
   * @param {Object} data - Güncellenecek departman verisi
   * @returns {Promise} Update response promise
   */
  ...
  /**
   * İletişim Bilgileri API çağrıları
   */
  
  /**
   * Tüm iletişim bilgilerini getirir
   * 
   * @returns {Promise} Contacts array promise
   */
  getContacts: () => apiRequest.get('/hospital/contacts'),
  
  /**
   * Yeni iletişim bilgisi ekler
   * 
   * @param {Object} data - İletişim verisi
   * @returns {Promise} Create response promise
   */
   ...
   * 
   * @param {number} contactId - İletişim ID'si
   * @param {Object} data - Güncellenecek iletişim verisi
   * @returns {Promise} Update response promise
   */
