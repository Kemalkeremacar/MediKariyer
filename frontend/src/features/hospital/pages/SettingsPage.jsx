...
import { useDeactivateHospitalAccount } from '../api/useHospital';
...
const HospitalSettingsPage = () => {
  ...
  const deactivateAccountMutation = useDeactivateHospitalAccount();
        ...
        <div className="relative mb-8 overflow-hidden rounded-3xl border border-cyan-200/30 bg-gradient-to-br from-cyan-100 via-blue-50 to-sky-100 p-8 shadow-[0_20px_60px_-30px_rgba(14,165,233,0.35)]">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <p className="text-cyan-700/80 text-sm font-semibold tracking-wider uppercase">Hastane Ayarları</p>
